const combos = (num) => {
    ...
    const findCombinations = (currentCombo, //Поточне комбо
    remainingSum, //Суму що ще треба отримати,це різниця між даним числом та сумою чисел поточного комбо
    startNum //Стартове число
    ) => {
